...
<head>
    ...
    {{-- Bootstrap 4, CSS mặc định của template --}}
    <link rel="stylesheet" href="{{ asset('client_resources/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('client_resources/css/mediumish.css') }}">
</head>
    ...
    <nav class="navbar navbar-toggleable-md navbar-light bg-white fixed-top mediumnavigation">
        ...
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="{{ asset('client_resources/img/logo.png') }}" alt="">
            </a>
            <!-- End Logo -->
 ...
 ================================================== -->
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-5 wrapthumbnail">
                            <a href="post.html">
                                <div class="thumbnail"
                                    style="background-image:url({{ asset('client_resources/img/demopic/1.jpg') }})">
                                </div>
                            </a>
                        </div>
                        <div class="col-md-7">
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-5 wrapthumbnail">
                            <a href="post.html">
                                <div class="thumbnail"
                                    style="background-image:url({{ asset('client_resources/img/demopic/2.jpg') }});">
                                </div>
                            </a>
                        </div>
                        <div class="col-md-7">
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-5 wrapthumbnail">
                            <a href="post.html">
                                <div class="thumbnail"
                                    style="background-image:url({{ asset('client_resources/img/demopic/3.jpg') }});">
                                </div>
                            </a>
                        </div>
                        <div class="col-md-7">
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-5 wrapthumbnail">
                            <a href="post.html">
                                <div class="thumbnail"
                                    style="background-image:url({{ asset('client_resources/img/demopic/4.jpg') }});">
                                </div>
                            </a>
                        </div>
                        <div class="col-md-7">
        ...
        <section class="recent-posts">
            ...
            <div class="card-columns listrecent">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{ asset('client_resources/img/demopic/5.jpg') }}"
                            alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{ asset('client_resources/img/demopic/6.jpg') }}"
                            alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{ asset('client_resources/img/demopic/7.jpg') }}"
                            alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{ asset('client_resources/img/demopic/8.jpg') }}"
                            alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{ asset('client_resources/img/demopic/9.jpg') }}"
                            alt="">
                    </a>
                    <div class="card-block">
                ...
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid" src="{{ asset('client_resources/img/demopic/10.jp') }}g"
                            alt="">
                    </a>
                    <div class="card-block">
